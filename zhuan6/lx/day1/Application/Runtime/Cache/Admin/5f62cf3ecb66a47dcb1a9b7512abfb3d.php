		...
		<div id="menu-list">
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  <li class="menu-item"><a href="<?php echo U('Brand/index');?>" target="main-frame">商品列表</a></li>
				...
				<li class="collapse" key="10_priv_admin" name="menu"> 权限管理        
					<ul style="display: none;">
						<li class="menu-item"><a href="<?php echo U('Admin/index');?>" target="main-frame">用户列表</a></li>
						<li class="menu-item"><a href="<?php echo U('Role/index');?>" target="main-frame">角色列表</a></li>
						
						<li class="menu-item"><a href="<?php echo U('Node/index');?>" target="main-frame">权限列表</a></li>
