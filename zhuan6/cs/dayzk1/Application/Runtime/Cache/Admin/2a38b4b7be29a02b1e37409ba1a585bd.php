...
<base href="/zhuan6/cs/dayzk1/Public/Admin/" />
...
<h1>
<span class="action-span"><a href="/zhuan6/cs/dayzk1/index.php/Admin/Brand/add">添加品牌</a></span>
<span class="action-span1"><a href="index.php?act=main">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 商品品牌 </span>
<div style="clear:both"></div>
</h1>

<div class="form-div">
  <form action="/zhuan6/cs/dayzk1/index.php/Admin/Brand/index" method="get" name="searchForm">
...
<div class="list-div" id="listDiv">
  ...
  <table cellpadding="3" cellspacing="1">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
      ...
      <a href="/zhuan6/cs/dayzk1<?php echo ($vo["brand_logo"]); ?>" target="_brank">
      <img src="/zhuan6/cs/dayzk1<?php echo ($vo["brand_logo"]); ?>" width="16" height="16" border="0" alt="品牌LOGO">
      </a>
      </span>
        ...
        <input type="text" id="xg" data="<?php echo ($vo["brand_id"]); ?>" value="<?php echo ($vo["brand_desc"]); ?>" /> 
...
<script type="text/javascript" src="/zhuan6/cs/dayzk1/Public/js/jquery-1.8.3.js"></script>
<script type="text/javascript">
  $('#xg').live('blur',function(){
    ...
    $.ajax({
      url:"/zhuan6/cs/dayzk1/index.php/Admin/Brand/xg",
      type:"get",
