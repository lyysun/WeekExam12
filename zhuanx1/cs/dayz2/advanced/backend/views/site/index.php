                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?=Url::to(['course/show'])?>">课程列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?=Url::to(['course/add'])?>">添加课程</a>
                            </li>
                     ...
                     <li>
                        <a href="#">
                            <i class="fa fa fa-bar-chart-o"></i>
                            <span class="nav-label">微信菜单管理</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?=Url::to(['week3/add'])?>">添加菜单</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?=Url::to(['week3/show'])?>">生成菜单</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?=Url::to(['week3/index'])?>">查询菜单</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?=Url::to(['week3/del'])?>">删除菜单</a>
                            </li>
