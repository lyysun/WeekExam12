                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?=Url::to(['goods/add'])?>">添加商品</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?=Url::to(['goods/show'])?>">展示商品</a>
                            </li>
                            <li>
                ...
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header"><a class="navbar-minimalize minimalize-styl-2 btn btn-info " href="#"><i class="fa fa-bars"></i> </a>
                        <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                            <div class="form-group">
                                <input type="text" placeholder="请输入您需要查找 …" class="form-control" name="top-search" id="top-search">
                            </div>
                        </form>
                    </div>
                   ...
                   <!--   <li>
                            <form action="<?=yii\helpers\Url::to(['site/logout'])?>" method='post'>
                                ...
                                <input type='submit' value='退出' class='btn btn-link logout'>
                            </form>
                        </li> -->
                        <li class="dropdown">
