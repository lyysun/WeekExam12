...
class model{
     ...
     protected $_like='';
      ...
      public function __construct(){
        ...
        $name=get_called_class();//获取model层 表名
    ...
    //实例化表名
     public function _doTableName($name){
      ...
      public function like($zd,$field){
        $sql=" where $zd like '%".$field."%'";
        $this->_like=$sql;
        return $this;
      }

      public function select(){
      	 $sql="select ".$this->_fields." from ".$this->_table." ".$this->_join." ".$this->_group." ".$this->_where." ".$this->_order.' '.$this->_limit.' '.$this->_like;
         // var_dump($sql);die;
         // if($this->_where){
