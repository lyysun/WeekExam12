...
<?php $goodsObj = search_goods::find(' go.seller_id = '.$seller_id,20);$resultData = $goodsObj->find();?>
<div class="bigweb">
<section class="breadcrumb">
	<span>您当前的位置：</span> <a href="<?php echo IUrl::creatUrl("");?>">首页</a> » 商户主页
</section>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		addr="<?php echo isset($sellerRow['address'])?$sellerRow['address']:"";?>";
		// alert(addr);
		$.ajax({
			url:"<?php echo IUrl::creatUrl("yk/dtss");?>",
			type:"post",
			data:{addr:addr},
			dataType:'json',
